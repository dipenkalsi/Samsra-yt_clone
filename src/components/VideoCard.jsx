            ...
            <div className="flex flex-col mb-2 hover:bg-white/[0.15] transition-all ease-in duration-150 rounded-br-xl rounded-tl-xl">
                ...
                <div className="flex text-white mt-3">
                    ...
                    <div className="flex flex-col ml-3 overflow-hidden">
                        <span className="text-sm font-normal line-clamp-2 truncate">
                            {video?.title}
                        </span>
                        <span className="text-[12px] font-normal mt-2 text-white/[0.7] flex items-center">
                            {video?.author?.title}
                        ...
                        <div className="flex text-[12px] font-normal text-white/[0.7] truncate overflow-hidden">
